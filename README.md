...
- Click a dino to view details
  - Has a fusion calculator for hybrids
  - Has a Sanctuary Points calculator for sanctuary eligible creatures
  - Remembers individual levels, boosts, omega training points, DNA, and xp per dino
...
- Search for a move name and will return all dinos with that move (or contain partial match, such as piercing)

Feel free to suggest features/refinements. This is my very first attempt at an android app (claude and google's ai studio helped!), so constructive feedback is welcomed.
